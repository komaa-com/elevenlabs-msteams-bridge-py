...
from elevenlabs_msteams_bridge.hmac_auth import (
...
from elevenlabs_msteams_bridge.server import ReplayGuard, authorize_upgrade, call_id_from_path
...
def test_authorize_accepts_legacy_headers():
    ...
    assert authorize_upgrade(cfg, "/stream/call-1", headers) == {"callId": "call-1"}
