...
_META: dict[str, tuple[str, str]] = {
    ...
    "bridge_frames_to_agent_total": ("Caller audio frames relayed to ElevenLabs", "counter"),
    ...
    "bridge_el_connect_failures_total": ("ElevenLabs session connect failures", "counter"),
}
